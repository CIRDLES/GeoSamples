...
public class ObjectFactory {
    ...
    private static final QName _Url_QNAME = new QName("http://app.geosamples.org", "url");
    private static final QName _CollectorDetail_QNAME = new QName("http://app.geosamples.org", "collector_detail");
    private static final QName _Country_QNAME = new QName("http://app.geosamples.org", "country");
    private static final QName _Size_QNAME = new QName("http://app.geosamples.org", "size");
    private static final QName _PrimaryLocationType_QNAME = new QName("http://app.geosamples.org", "primary_location_type");
    private static final QName _County_QNAME = new QName("http://app.geosamples.org", "county");
    private static final QName _CurrentArchive_QNAME = new QName("http://app.geosamples.org", "current_archive");
    private static final QName _UrlType_QNAME = new QName("http://app.geosamples.org", "url_type");
    private static final QName _PlatformType_QNAME = new QName("http://app.geosamples.org", "platform_type");
    private static final QName _CruiseFieldPrgrm_QNAME = new QName("http://app.geosamples.org", "cruise_field_prgrm");
    private static final QName _LaunchPlatformName_QNAME = new QName("http://app.geosamples.org", "launch_platform_name");
    private static final QName _SampleComment_QNAME = new QName("http://app.geosamples.org", "sample_comment");
    private static final QName _Northing_QNAME = new QName("http://app.geosamples.org", "northing");
    private static final QName _GeologicalAge_QNAME = new QName("http://app.geosamples.org", "geological_age");
    private static final QName _AgeUnit_QNAME = new QName("http://app.geosamples.org", "age_unit");
    private static final QName _IsPrivate_QNAME = new QName("http://app.geosamples.org", "is_private");
    private static final QName _Latitude_QNAME = new QName("http://app.geosamples.org", "latitude");
    private static final QName _OriginalArchiveContact_QNAME = new QName("http://app.geosamples.org", "original_archive_contact");
    private static final QName _SizeUnit_QNAME = new QName("http://app.geosamples.org", "size_unit");
    private static final QName _PlatformDescr_QNAME = new QName("http://app.geosamples.org", "platform_descr");
    private static final QName _FieldName_QNAME = new QName("http://app.geosamples.org", "field_name");
    private static final QName _DepthMin_QNAME = new QName("http://app.geosamples.org", "depth_min");
    private static final QName _CollectionMethod_QNAME = new QName("http://app.geosamples.org", "collection_method");
    private static final QName _City_QNAME = new QName("http://app.geosamples.org", "city");
    private static final QName _UserCode_QNAME = new QName("http://app.geosamples.org", "user_code");
    private static final QName _CollectionStartDate_QNAME = new QName("http://app.geosamples.org", "collection_start_date");
    private static final QName _DepthMax_QNAME = new QName("http://app.geosamples.org", "depth_max");
    private static final QName _LocationDescription_QNAME = new QName("http://app.geosamples.org", "location_description");
    private static final QName _PlatformName_QNAME = new QName("http://app.geosamples.org", "platform_name");
    private static final QName _Description_QNAME = new QName("http://app.geosamples.org", "description");
    private static final QName _UrlDescription_QNAME = new QName("http://app.geosamples.org", "url_description");
    private static final QName _Province_QNAME = new QName("http://app.geosamples.org", "province");
    private static final QName _LocalityDescription_QNAME = new QName("http://app.geosamples.org", "locality_description");
    private static final QName _OriginalArchive_QNAME = new QName("http://app.geosamples.org", "original_archive");
    private static final QName _Longitude_QNAME = new QName("http://app.geosamples.org", "longitude");
    private static final QName _PublishDate_QNAME = new QName("http://app.geosamples.org", "publish_date");
    private static final QName _Elevation_QNAME = new QName("http://app.geosamples.org", "elevation");
    private static final QName _CollectionDatePrecision_QNAME = new QName("http://app.geosamples.org", "collection_date_precision");
    private static final QName _Material_QNAME = new QName("http://app.geosamples.org", "material");
    private static final QName _AgeMax_QNAME = new QName("http://app.geosamples.org", "age_max");
    private static final QName _Easting_QNAME = new QName("http://app.geosamples.org", "easting");
    private static final QName _ParentIgsn_QNAME = new QName("http://app.geosamples.org", "parent_igsn");
    private static final QName _Igsn_QNAME = new QName("http://app.geosamples.org", "igsn");
    private static final QName _NavigationType_QNAME = new QName("http://app.geosamples.org", "navigation_type");
    private static final QName _CollectionEndDate_QNAME = new QName("http://app.geosamples.org", "collection_end_date");
    private static final QName _Zone_QNAME = new QName("http://app.geosamples.org", "zone");
    private static final QName _Locality_QNAME = new QName("http://app.geosamples.org", "locality");
    private static final QName _LaunchTypeName_QNAME = new QName("http://app.geosamples.org", "launch_type_name");
    private static final QName _SampleType_QNAME = new QName("http://app.geosamples.org", "sample_type");
    private static final QName _LongitudeEnd_QNAME = new QName("http://app.geosamples.org", "longitude_end");
    private static final QName _LatitudeEnd_QNAME = new QName("http://app.geosamples.org", "latitude_end");
    private static final QName _VerticalDatum_QNAME = new QName("http://app.geosamples.org", "vertical_datum");
    private static final QName _LaunchId_QNAME = new QName("http://app.geosamples.org", "launch_id");
    private static final QName _AgeMin_QNAME = new QName("http://app.geosamples.org", "age_min");
    private static final QName _ClassificationComment_QNAME = new QName("http://app.geosamples.org", "classification_comment");
    private static final QName _Purpose_QNAME = new QName("http://app.geosamples.org", "purpose");
    private static final QName _Name_QNAME = new QName("http://app.geosamples.org", "name");
    private static final QName _SampleOtherName_QNAME = new QName("http://app.geosamples.org", "sample_other_name");
    private static final QName _ElevationEnd_QNAME = new QName("http://app.geosamples.org", "elevation_end");
    private static final QName _Collector_QNAME = new QName("http://app.geosamples.org", "collector");
    private static final QName _GeologicalUnit_QNAME = new QName("http://app.geosamples.org", "geological_unit");
    private static final QName _PrimaryLocationName_QNAME = new QName("http://app.geosamples.org", "primary_location_name");
    private static final QName _DepthScale_QNAME = new QName("http://app.geosamples.org", "depth_scale");
    private static final QName _CurrentArchiveContact_QNAME = new QName("http://app.geosamples.org", "current_archive_contact");
    private static final QName _CollectionMethodDescr_QNAME = new QName("http://app.geosamples.org", "collection_method_descr");
